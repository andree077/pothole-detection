...
def predict_pothole(currentFrame):
    ...
    prob = loadedModel.predict_step(currentFrame)
    max_prob = max(prob[0])
    if(max_prob>.90):
        return loadedModel.predict_step(currentFrame) , max_prob
    return "none",0

# main function
if __name__ == '__main__':

    loadedModel = load_model('C:/Projects/CODEutsava/potholeDetection/model/full_model.h5')
